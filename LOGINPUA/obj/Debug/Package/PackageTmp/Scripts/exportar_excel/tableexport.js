        ...
        var TableExport = function (selectors, options, isUpdate) {
            ...
            self.selectors.each(function () {
                ...
                function checkCaption(exportButton) {
                    ...
                    $caption.length ? $caption.append(exportButton) : $el.prepend('<caption id="button_export" style="color:red" class="' + bootstrapSpacing + self.settings.position + '" >' + exportButton + '</caption>');
                }
                ...
                function createObjButton(dataObject, myContent, myClass) {
                     var exportButton = "<button data-fileblob='" + dataObject + "' class='"+"btn btn-success btn-sm"+"'>" + myContent + "</button>";
