                        ...
                        $.each(rows, function (key2, arrayHijo) {
                            ...
                            if (this.HORA_SALIDA != null) {
                                ...
                                if (this.LADO == "A") {
                                    ...
                                    td_hora_salidaA = "<td>" + this.HORA_SALIDA + "</td>"
                                    ...
                                    td_hora_salidaB = "<td> " + this.HORA_SALIDA + "</td>"
                            ...
                            if (conductor == "1 - null, null") {
                                ...
                                conductor="<span style='font-weight: bold;'> CONDUCTOR SIN CAC</span>";
                            }

                            totalTD = "<td>" + this.SERVICIO + "</td><td>" + this.UNIDAD + "</td><td>" + empresa + "</td><td>" + conductor + "</td><td style='color:red'>M</td>" + td1A + td2A + td3A + td4A + td5A + td6A + td7A + td8A + td1B + td2B + td3B + td4B + td5B + td6B + td7B + td8B + "<td style='color:red'>" + counttdA + "</td><td style='color:red'>" + counttdB + "</td>";
