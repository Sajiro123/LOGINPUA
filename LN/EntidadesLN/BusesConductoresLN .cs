...
{
    public class BusesConductoresLN 
    {
        private Object bdConn;
        private BusesConductoresAD _PasajeroValidadacion;

        public BusesConductoresLN()
        {
            _PasajeroValidadacion = new BusesConductoresAD(ref bdConn);
        }
